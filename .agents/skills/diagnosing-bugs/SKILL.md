...
description: Builds tight feedback loops to diagnose hard bugs and performance regressions. Use when debugging broken, failing, throwing, flaky, or slow behavior.
license: MIT
metadata:
